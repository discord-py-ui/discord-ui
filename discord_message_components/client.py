import asyncio
from .slash.tools import create_command, create_guild_command, get_commands, get_guild_commands
...
class Slash():
    ...
    async def add_command(self, callback, name, description, choices=MISSING, guild_ids=MISSING):
